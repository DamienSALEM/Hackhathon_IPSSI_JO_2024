        ...
        <div className="relative z-10">
          ...
          <div className="h-[250px] flex justify-center items-center p-10">
            <p className="text-lg text-white text-center">
              ...
              l'IPSSI Paris, a pour objectif de développer des modèles
              prédictifs pour les résultats des Jeux Olympiques de Paris 2024.
              Pendant une semaine, les participants travaillent en équipes, en
              collaboration à distance, pour concevoir, développer et présenter
